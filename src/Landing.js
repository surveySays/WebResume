        ...
        <BrowserView style={{ height: "100%", width: "100%" }}>
            ...
            </h1>
            {
              isDesktop ? (
                <FadeIn>
                  ...
                  >
                    <a onClick={this.handleOnClickAbout}>
                      <h2
                        style={{
                          marginRight: 30,
                          marginLeft: 30,
                    ...
                    <a onClick={this.handleOnClickProjects}>
                      <h2
                        style={{
                          marginRight: 30,
                          cursor: "pointer",
                    ...
                    <a onClick={this.handleOnClickSkills}>
                      <h2
                        style={{
                          marginRight: 30,
                          cursor: "pointer",
                    ...
                    <a onClick={this.handleOnClickWorkHistory}>
                      <h2
                        style={{
                          marginRight: 30,
                          cursor: "pointer",
                    ...
                    <a onClick={this.handleOnClickConnect}>
                      <h2
                        style={{
                          marginRight: 30,
                          cursor: "pointer",
              ...
              //   >
              //     <MenuItem onClick={this.handleOnClickAbout}>About</MenuItem>
              //     <MenuItem onClick={this.handleOnClickProjects}>
              //       Projects
              //     </MenuItem>
              //     <MenuItem onClick={this.handleOnClickSkills}>
              //       Skills
              //     </MenuItem>
              //     <MenuItem onClick={this.handleOnClickWorkHistory}>
              //       Work History
              //     </MenuItem>
              //     <MenuItem onClick={this.handleOnClickConnect}>
              //       Connect
              //     </MenuItem>
              //   </Menu>
              // </div>
          ...
          <div className={classes.section} ref={this.About}>
            <div style={{ margin: 40 }}>
              ...
              <p style={{ fontFamily: "Montserrat" }}>
                I am currently working full-time as a Bridge Drafter for a
                company throughout the Pacific North West. They specialize in
                roadway, bridge, structural and marine practice area engineering
              ...
              <p style={{ fontFamily: "Montserrat" }}>
                ...
                constanty working on side projects including web apps,
                iOS/android apps using React Native, and keeping my skills sharp
                with C++ & JavaScript algorithms.
              </p>
            </div>
          </div>
          ...
          <div className={classes.section} ref={this.Projects}>
            ...
            >
              ...
              >
                These are some of my past or current projects. I always like to
                be coding to stay sharp with my skills.
              </Typography>
              {isDesktop ? (
                <div className={classes.row}>
                  <div className={classes.column}>
                    ...
                    <p style={{ maxWidth: "450px", fontFamily: "Montserrat" }}>
                      A web application that my Junior Project team and I
                      developed. This application mimics Discord and Omegle
                      allowing you to chat anonymously with people with similar
                      interest.
                    </p>
                    <a
                  ...
                  <div className={classes.column}>
                    ...
                    <p style={{ maxWidth: "450px", fontFamily: "Montserrat" }}>
                      A web application that I am working on to show off my
                      senior project. This will act as a landing page if someone
                      were to google my app name on the web.
                    </p>
                    <a
          ...
          <div className={classes.section} ref={this.WorkHistory}>
            <div style={{ margin: 40 }}>
              ...
              <p style={{ fontFamily: "Montserrat" }}>
                Working with AutoCAD, AutoCAD Civil 3D, and MicroStation to
                create 2D bridge plans. Working in a team environment with
                designers, engineers, and other CAD drafters. Working solely on
                certain projects for the majority of the projects scope. Working
                with other people's work and continuing the project where they
                left off.
              </p>
              <br />
              {isDesktop ? (
              ...
              <p style={{ fontFamily: "Montserrat" }}>
                Working with AutoCAD and Inventor Professional. Creating 2D and
                3D customer and fabrication plans. Working in a team environment
                to develop and design certain parts including designing mockup
                3D parts in Inventor Professional. Working from start-to-finish
                on certain projects solely.
              </p>
              <br />
              {isDesktop ? (
                <div
              ...
              <p style={{ fontFamily: "Montserrat" }}>
                Working with a Survey Crew Chief to create topography maps using
                a S6 Trimble Total Station. Transferring data points to csv
                formatted files. Using handheld computers to tie in
                GPS/Satellites points onto the topography map. Working with
                extreme precision to create a 00+0.001 error ratio.
              </p>
              <br />
              {isDesktop ? (
                <div
